...
namespace SAP_B1 {
    ...
    public class billing : ReportClass {
    ...
    public class Cachedbilling : Component, ICachedReport {
        
        public Cachedbilling() {
        }
